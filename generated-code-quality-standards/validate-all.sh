...
KNOWN_NAMESPACES=(google us-government european-union finance-industry owasp w3c web-vitals react node typescript slsa linux-foundation industry-self-regulatory aws azure gcp hashicorp security-governance documentation md _universal _operator _community _meta)
