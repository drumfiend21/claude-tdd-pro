...
10 specs (`cl564-refresh-01..10`): html-sections-yields-segments / free-prose-yields-segments / pdf-sections-yields-segments / markdown-headings-regression / http-get-fetches-url / orchestrator-walks-registry / freshness-skip-honored / force-overrides-skip / content-hash-preserves-introduced-in / deprecated-at-on-removal. **§20 note:** completes ADR-0009 line 50 (orchestrator) + line 51 (5 shapes); activates the previously-unwired S-2 dispatch layer as the fetch precursor to Stage 1; preserves §28.40 grandfathering. Composes forward with CL-565 scheduler wire-through (one-line replacement of `--upstream-stub` in C-19/S-17) and CL-566 LLM Tier-2 integration (Wave-2 per ADR-0009). Preserves §21 dod. Suite 5041→5051.
