---
name: Claude TDD Pro v1.9 (+ v1.9.1 + v1.10 amendments) — full architecture text (verbatim mirror)
description: Verbatim mirror of docs/architecture-v1.9.md auto-refreshed by hooks/scripts/sync-memory.sh on session start. v1.9 base + v1.9.1 §23 (H-12, W-10, X-6, X-7, §2.23, §2.24, §23.7 substrate reconciliation, §23.8 phase glossary) + v1.10 §24 (X-8 LSP, X-9 cloud devcontainer, P-10 model router, W-11 parallel subagents, W-12 conversational PR reviewer, O-12 application scaffolds). Internal-consistency regressions fixed: §2.8 models_used router shape, §2.14 dry-run subjects, §2.15 concurrent envelopes, §21 DoD upper bounds, §1 diagram amendments note. Source of truth is docs/architecture-v1.9.md.
type: project
---

<!-- preamble preserved from prior pointer file -->

## Quick chapter map (canonical at [../architecture-v1.9.md](../architecture-v1.9.md))
...
- **§18** — Cumulative file/component inventory
- **§19** — Out of scope
- **§20** — Execution order (weeks 1-30)
- **§21** — Definition of done
- **§22** — Confidence ranking summary
- **§23** — v1.9.1 optimization amendments
- **§24** — v1.10 surface expansion amendments

**Next available ID cursor (per §24.7):** P-11, X-10, W-13, O-13, H-13, plus any unused IDs in F/E/G/S/C/R/N/T/Q/L.

**Discipline:** every CL must extract literal feature IDs from the canonical text below. No paraphrasing, no invention, no inferred decomposition.

---

<!-- begin verbatim text from docs/architecture-v1.9.md -->
